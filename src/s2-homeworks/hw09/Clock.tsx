...
function Clock() {
    ...
    const dateWithZero = date.getDate() < 10 ? '0' + date.getDate() : date.getDate()
    const monthWithZero = date.getMonth() < 10 ? '0' + date.getMonth() : date.getMonth()
    ...
    const stringDate =
        (`${dateWithZero.toString()}.${(+monthWithZero + 1).toString()}.${date.getFullYear().toString()}`)|| <br/>; // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем
